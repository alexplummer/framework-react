...
var TextList = function (_React$Component) {
    inherits(TextList, _React$Component);

    function TextList() {
        classCallCheck(this, TextList);
        return possibleConstructorReturn(this, (TextList.__proto__ || Object.getPrototypeOf(TextList)).apply(this, arguments));
    }

    createClass(TextList, [{
        key: 'render',
        value: function render() {
            var newId = 1;

            var itemsList = this.props.items.map(function (thisItem) {
            ...
            return react.createElement(
                ...
                react.createElement(
                    'form',
                    null,
                    react.createElement('input', { type: 'text', className: 'item-text' }),
                    react.createElement(
                        'button',
                        { type: 'button', onClick: addItem.bind(this) },
                        'Add item'
                    )
                )
            );
...
// Imports
var TextListContainer = function TextListContainer(_ref) {
    var items = _ref.items,
        actions = _ref.actions;
    return react.createElement(TextList, { items: items, actions: actions });
};
...
// Exports
var TextListContainer$1 = connect(mapStateToProps, mapDispatchToProps)(TextListContainer);
...
// Imports
var ListOfThings = function (_React$Component) {
    inherits(ListOfThings, _React$Component);

    function ListOfThings() {
        classCallCheck(this, ListOfThings);
        return possibleConstructorReturn(this, (ListOfThings.__proto__ || Object.getPrototypeOf(ListOfThings)).apply(this, arguments));
    }

    createClass(ListOfThings, [{
        key: 'render',
        value: function render() {
            return react.createElement(TextListContainer$1, null);
        }
    }]);
    return ListOfThings;
}(react.Component);
...
reactDom.render(react.createElement(
    Provider,
    { store: store },
    react.createElement(ListOfThings, null)
